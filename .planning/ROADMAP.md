...
|-------|-------|------|-------------|
| 1 | Foundation & Styling Setup | Tailwind installed, design tokens configured, scaffold replaced | REQ-001–004 |
...
Plans:
- [ ] 01-01-PLAN.md — Install Tailwind CSS v3, configure PostCSS pipeline, write design tokens, replace index.css with Tailwind directives

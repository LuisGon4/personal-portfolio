...
| 7 | Visual Polish — Color, Photo & Decorations | Accent color, profile photo, geometric shapes, section bands | — |
| 8 | Polish & Accessibility Audit | Responsiveness, a11y, meta tags, final review | REQ-060–066 |
...
Plans:
- [x] 06-01-PLAN.md — Install lucide-react, replace Contact.jsx stub with GitHub/LinkedIn/email icon links
...
## Phase 7: Visual Polish — Color, Photo & Decorations

**Goal:** Elevate the visual aesthetic with accent color, profile photo in hero, geometric decorations, and alternating section backgrounds.

**Plans:** 1 plan

Plans:
- [x] 07-01-PLAN.md — Accent color token, two-column hero with photo, geometric shapes, section tints, ProjectCard tag hover

**Success Criteria:**
1. `npm run dev` — no errors
2. Hero shows two-column layout on desktop, stacked on mobile
3. Photo slot visible; grayscale default, color on hover
4. Projects and Contact sections have `bg-slate-50` tint
5. Accent dots visible on section headings
6. Large circle + small square decorations visible in hero
